...
CXXFLAGS = -g -O2 -Wall -std=gnu++11 -fstack-protector-all -Wextra -I. -I/usr/local/include

LIBS = -lpthread -fstack-protector -lcurl -L/usr/local/lib
...
DEPS = vbit2.h service.h configure.h pagelist.h ttxpage.h packet.h tables.h ttxpagestream.h ttxline.h carousel.h filemonitor.h command.h TCPClient.h newfor.h hamm-tables.h packetsource.h packetmag.h packet830.h packetsubtitle.h ttxcodes.h specialpages.h normalpages.h spoteefax.h spclient.h jspextractor.h

OBJ = vbit2.o service.o configure.o pagelist.o ttxpage.o packet.o tables.o ttxpagestream.o ttxline.o carousel.o filemonitor.o command.o TCPClient.o newfor.o packetsource.o packetmag.o packet830.o packetsubtitle.o specialpages.o normalpages.o spoteefax.o
